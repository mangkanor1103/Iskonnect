        ...
        <div class="p-4 mb-2 bg-gradient-to-r from-green-500 to-green-400 text-white">
            <div class="flex items-center justify-center">
                <svg class="w-8 h-8 mr-2 animate-pulse" fill="currentColor" viewBox="0 0 20 20"
                    ...
                    <path
                        d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838l-2.727 1.17 1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zm9.3 2.108a1 1 0 00-1.842.746A11.091 11.091 0 0110 15.5c-2.28 0-4.402-.396-6-1.104v-4.3s.374.15 1.1.213c1.2.103 2.716-.204 4.446-.524 1.72-.316 3.437-.67 4.946-.689h.015c.67 0 1.323.065 1.894.213A8.935 8.935 0 0117 11.323a1 1 0 00-1-1h-.013l-1.38.268a.5.5 0 01-.638-.47v-.422a.5.5 0 01.314-.465l1.415-.598a1 1 0 00-.026-1.845l-3.246-1.262a.5.5 0 01-.28-.615c.09-.252.14-.4.159-.547A.5.5 0 0011.7 4.21l.33-.237a1 1 0 00.12-1.403l-.16-.219a1 1 0 00-1.413-.12l-1.489 1.085a.5.5 0 01-.635-.076l-.246-.313a.5.5 0 01-.092-.562L8.939.317a1 1 0 00-.363-1.118.942.942 0 00-.935-.018 1 1 0 00-.45.61l-.39 1.301a.5.5 0 01-.534.336l-.534-.074a.5.5 0 01-.432-.425l-.109-.664a1 1 0 00-1.237-.816l-.04.007a1 1 0 00-.776 1.105l.088.596a.5.5 0 01-.426.538l-.534.074a.5.5 0 01-.535-.337l-.39-1.3a1 1 0 00-1.748-.593l-.393.393a1 1 0 00-.12 1.235l.214.427a.5.5 0 01-.076.635l-.313.246a.5.5 0 01-.562.092l-.427-.214a1 1 0 00-1.235.12l-.393.393a1 1 0 00.474 1.676">
                    </path>
                </svg>
    ...
    <div class="flex-1 overflow-y-auto bg-gradient-to-br from-white to-green-50">
        ...
        <div
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4 bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Student
                </div>
            </div>
                    ...
                    <?php if (!empty($post['deadline']) && $is_expired): ?>
                        <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 flex items-center">
                            ...
                            <div>
                                ...
                                <p>The application deadline was <?php echo date('F j, Y', $deadline); ?>. Please check other
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="text-sm text-gray-500 mb-2">
                                        <?php echo htmlspecialchars(substr($post['attachment'], strpos($post['attachment'], '_') + 1)); ?>
                                    </p>
                                    <a href="../uploads/attachments/<?php echo htmlspecialchars($post['attachment']); ?>"
                                        class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md shadow-sm font-medium hover:bg-green-700 transition-colors"
