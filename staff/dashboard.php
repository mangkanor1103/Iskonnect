            ...
            <ul class="space-y-1 p-3">
                ...
                <li class="group">
                    <a href="create_post.php"
                        ...
                        <span class="ml-3 text-gray-700 group-hover:text-green-700 font-medium">Create Scholarship
                            Post</span>
                    </a>
                </li>
                <li class="group">
    ...
    <div class="flex-1 overflow-y-auto bg-gradient-to-br from-white to-green-50 relative">
        ...
        <div class="p-6 animate__animated animate__fadeIn">
            <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
                <div class="flex flex-col md:flex-row">
                    <div class="md:w-2/3 p-8">
                        ...
                        <h1 class="mt-2 text-4xl font-bold text-gray-800 leading-tight">Welcome,
            ...
            <div class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <!-- Pending Students -->
                <div
                    class="bg-white overflow-hidden shadow rounded-lg transition-transform duration-300 hover:-translate-y-1">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900"><?php echo $pendingCount; ?>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                    ...
                    <div class="bg-yellow-50 px-4 py-2">
                        <a href="students.php" class="text-sm text-yellow-600 hover:text-yellow-900 font-medium">View
                            all</a>
                    </div>
                </div>
                ...
                <div
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900"><?php echo $approvedCount; ?>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                    ...
                    <div class="bg-green-50 px-4 py-2">
                        <a href="approved.php" class="text-sm text-green-600 hover:text-green-900 font-medium">View
                            all</a>
                    </div>
                </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900"><?php echo $rejectedCount; ?>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                ...
                <div
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900"><?php echo $postsCount; ?>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                    ...
                    <div class="bg-blue-50 px-4 py-2">
                        <a href="create_post.php" class="text-sm text-blue-600 hover:text-blue-900 font-medium">Create
                            new</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="flex items-center">
                                        <div class="min-w-0 flex-1">
                                            <p class="text-sm font-medium <?php echo $statusClass; ?> truncate">
                                                <?php echo $activity['type']; ?> - <span
                                                    class="<?php echo $bgClass; ?> px-2 py-0.5 rounded-full text-xs"><?php echo $activity['status']; ?></span>
                                            </p>
