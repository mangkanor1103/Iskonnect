...
<body class="bg-gradient-to-br from-green-100 via-green-200 to-green-300 min-h-screen">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <header class="bg-gradient-to-r from-green-600 to-green-800 text-white shadow-lg py-4">
            <div class="container mx-auto px-6 flex justify-between items-center">
                <div class="flex items-center animate__animated animate__fadeIn">
                    <lottie-player src="https://assets1.lottiefiles.com/packages/lf20_uwh9uhdt.json"
                        background="transparent" speed="1" style="width: 50px; height: 50px;" autoplay
                        loop></lottie-player>
        ...
        <div class="flex flex-1">
            ...
            <div class="sidebar w-64 border-r border-green-100 flex flex-col shadow-lg z-10 relative">
                <div class="p-4 mb-2 bg-gradient-to-r from-green-500 to-green-400 text-white">
                    <div class="flex items-center justify-center">
                        <svg class="w-8 h-8 mr-2 animate-pulse" fill="currentColor" viewBox="0 0 20 20"
                    ...
                    <ul class="space-y-1 p-3">
                        <li class="group">
                            <a href="dashboard.php"
                                class="flex items-center p-3 rounded-lg bg-green-50 hover:bg-green-50 transition-all duration-300 group-hover:translate-x-1 transform">
                                <svg class="w-5 h-5 text-green-500 group-hover:text-green-600 transition-colors"
                                    fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M3 12l2-2m0 0l7-7 7 7m-9 2v10m4-10l2 2m-2-2v10"></path>
                                </svg>
                                <span class="ml-3 text-gray-700 group-hover:text-green-700 font-medium">Dashboard</span>
                                <span
                                    class="ml-auto bg-green-100 text-green-600 text-xs px-2 py-0.5 rounded-full group-hover:bg-green-200 transition-colors duration-300">Home</span>
                            </a>
                        </li>
                        <li class="group">
                            <a href="add_staff.php"
                                class="flex items-center p-3 rounded-lg hover:bg-green-50 transition-all duration-300 group-hover:translate-x-1 transform">
                                <svg class="w-5 h-5 text-green-500 group-hover:text-green-600 transition-colors"
                                    fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li class="group">
                            <a href="ched_account.php"
                                ...
                                <span class="ml-3 text-gray-700 group-hover:text-green-700 font-medium">CHED
                                    Accounts</span>
                            </a>
                        </li>
                        <li class="group">
                            <a href="feedback.php"
                                ...
                                <span
                                    class="ml-auto bg-green-500 text-white text-xs px-2 py-0.5 rounded-full animate-pulse">New</span>
                            </a>
                        </li>
                        <li class="border-t border-gray-100 my-2 pt-2"></li>
                        <li class="group">
                            <a href="logout.php"
                                class="flex items-center p-3 rounded-lg hover:bg-red-50 transition-all duration-300">
                ...
                <div class="p-4 border-t border-gray-100">
                    <div class="flex items-center">
                        <div
                            class="w-8 h-8 rounded-full bg-green-200 flex items-center justify-center text-green-700 font-bold">
                            A</div>
                        <div class="ml-3">
            ...
            <div class="flex-1 overflow-y-auto p-6 animate__animated animate__fadeIn">
                ...
                <div class="dashboard-card rounded-xl shadow-lg overflow-hidden mb-8 animate__animated animate__fadeIn">
                    <div class="flex flex-col md:flex-row">
                        <div class="md:w-3/5 p-6">
                            <div class="uppercase tracking-wide text-sm text-green-500 font-semibold">Admin Dashboard
                            </div>
                            <h1 class="mt-1 text-3xl font-bold text-gray-800 leading-tight">Welcome Back!</h1>
                            <p class="mt-2 text-gray-600">You have successfully logged in to your dashboard. Here's your
                                system overview for today.</p>
                            <a href="feedback.php"
                                class="mt-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-300">
                            ...
                            <p class="mt-2 text-sm text-gray-500 italic">Access and manage feedback submissions from students</p>
                        </div>
                        <div class="md:w-2/5 bg-green-100 p-4 flex items-center justify-center">
                            <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_iorpbol0.json"
                                background="transparent" speed="1" class="w-full max-w-xs" autoplay
                                loop></lottie-player>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div
                        class="dashboard-card rounded-xl shadow-md p-6 animate__animated animate__fadeInUp animate__delay-1s">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900"><?php echo $staff_count; ?>
                                        </div>
                    ...
                    <div
                        class="dashboard-card rounded-xl shadow-md p-6 animate__animated animate__fadeInUp animate__delay-2s">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900"><?php echo $ched_count; ?>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                    ...
                    <div
                        class="dashboard-card rounded-xl shadow-md p-6 animate__animated animate__fadeInUp animate__delay-3s">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Feedback Messages</dt>
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900"><?php echo $feedback_count; ?>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                    ...
                    <div
                        class="dashboard-card rounded-xl shadow-md p-6 animate__animated animate__fadeInUp animate__delay-4s">
                        <div class="flex items-center">
        ...
        <!-- About Modal -->
        <div id="aboutModal"
            class="fixed inset-0 bg-black bg-opacity-50 z-40 flex justify-center items-center hidden modal">
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 animate__animated animate__fadeInDown">
                ...
                <div class="p-4 md:p-6">
                    ...
                    <div class="space-y-3 text-gray-600">
                        <p>Iskonnect is a comprehensive management platform designed for educational institutions to
                            streamline communication between staff and CHED officials.</p>
                        <p>Our mission is to simplify administrative tasks and improve coordination between different
                            stakeholders in the education sector.</p>
                        <p>Developed by the IT Department of Iskonnect, this platform offers robust features for user
                            management, reporting, and data analytics.</p>
                    </div>
